...
//     const visits = await Visit.find({ urlId: url._id }).sort({ timestamp: -1 }).limit(100);

//     // Build daily click chart data (last 14 days)
//     const now = new Date();
...
//     const clicksByDay = {};
//     days.forEach((d) => (clicksByDay[d] = 0));
//     visits.forEach((v) => {
